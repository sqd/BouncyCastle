...
_NODE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='country_code', full_name='bfcp.Node.country_code', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_known_address', full_name='bfcp.Node.last_known_address', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_port', full_name='bfcp.Node.last_port', index=3,
...
_ENDNODEREQUIREMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='not', full_name='bfcp.EndNodeRequirement.not', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CHANNELREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='connection_params', full_name='bfcp.ChannelRequest.connection_params', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ENDNODEREQUIREMENT.fields_by_name['not'].message_type = _ENDNODEREQUIREMENT
...
_ENDNODEREQUIREMENT.oneofs_by_name['requirement'].fields.append(
  _ENDNODEREQUIREMENT.fields_by_name['not'])
_ENDNODEREQUIREMENT.fields_by_name['not'].containing_oneof = _ENDNODEREQUIREMENT.oneofs_by_name['requirement']
...
_CHANNELREQUEST.fields_by_name['connection_params'].message_type = _CONNECTIONROUTINGPARAMS
